		...
		<div className="home-page text-center">
			...
			<div className="cover-container mx-auto d-flex w-100 align-items-center">
				<div role="main" className="inner cover">
					...
					<p>Spend time with your partner, wherever you may be. Join in and have fun in <strong>real-time</strong>. Activities are always more fun together. Come on in, it&apos;s free!</p>

...
SECRET_KEY = 'wni2sd*s6skl-_g56rshwj4jcg@eivm5%y)h^70(*s5((z%ab2'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'togetherapp/templates']
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
ASGI_APPLICATION = 'together.routing.application'
CHANNEL_LAYERS = {
    'default': {
...
AUTH_USER_MODEL = 'togetherapp.User'
